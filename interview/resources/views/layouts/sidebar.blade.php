<div class="col-12 col-lg-4 col-xl-3 vh-100 sidebar">
    ...
    <div class="nav-menu">
        <ul>
            ...
            <x-menu-item class="fas fa-plus-circle" name="Create Category" link="{{ route('category.create') }}"></x-menu-item>
            <x-menu-item class="fas fa-list" name="Category List" counter="{{ count(\App\Category::all()) }}" link="{{ route('category.index') }}"></x-menu-item>
